...
include('../config/DbFunction.php');
	...
	if(isset($_POST['submit'])){
     ...
     $obj->register($_POST['course-short'],$_POST['session'],$_POST['fname'],$_POST['mname'],$_POST['lname'],
...
<option VALUE="">SELECT</option>
		...
		<div class="col-lg-6">
 <input class="form-control" name="cfull"  id="c-full" >
       </select>
	</div>
	 </div>	
...
<option VALUE="">SELECT Session</option>
				...
				<?php while($res1=$ses->fetch_object()){?>							
			
                        <option VALUE="<?php echo htmlentities($res1->id);?>"><?php echo htmlentities($res1->session)?></option>
